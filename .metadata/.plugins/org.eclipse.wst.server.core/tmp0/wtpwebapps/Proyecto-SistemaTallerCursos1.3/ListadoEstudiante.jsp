...
<title>Listado de Estudiantes - Taller de cursos de verano</title>
...
<div class="container">
    ...
    <a href="FrmRegistrarEstudiante.jsp" class="btn btn-success registrar-estudiante">Registrar Nuevo</a>
    | <a href="MenuPrincipal.jsp" class="btn btn-warning">Ir al Menu</a>
    
<br>
<br>
<table id="tabla2" style="text-align: center;" class="table table-striped">
...
<tr>
<td><c:out value="${estudiante.idestudiante}"></c:out></td>
...
<td><!-- <a href="ControladorEstudiante?accion=Actualizar&buscaest=${estudiante.dni}" class="btn btn-warning btn-sm">Actualizar</a> -->
        <a href="#" class="editar-estudiante" data-idestudiante="<c:out value='${estudiante.idestudiante}' />" data-dni="<c:out value='${estudiante.dni}' />" data-nombre="<c:out value='${estudiante.nombre}' />" data-apellido="<c:out value='${estudiante.apellido}' />" data-correo="<c:out value='${estudiante.correo}' />" data-telefono="<c:out value='${estudiante.telefono}' />">
    <img src="img/editar6.png">
  </a>
        <c:if test="${estudiante.estado eq 'no'}">
            
                <a id="eliminar" style="margin-left:10px;" href="ControladorEstudiante?accion=Eliminar&idest=${estudiante.idestudiante}">
                <input type="hidden" id="codigo" value="${estudiante.idestudiante}"><img src="img/eliminar6.png"></a>
...
<script type="text/javascript" src="js/funcionesestudiante.js"></script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info text-center">
        <h4 class="modal-title text-white mx-auto" id="actualizarModalLabel">Actualizar Estudiante</h4>
      ...
      <div class="modal-body">
        ...
        <form id="form-actualizar" action="ControladorEstudiante?accion=Actualizar" method="post">
...
<!-- Script para capturar los datos del estudiante y cargarlos en el formulario del modal -->
<script>
$(document).ready(function() {
  // Al hacer clic en el enlace de editar, obtener los valores del docente y cargarlos en el formulario del modal
  $('a.editar-estudiante').click(function(e) {
    e.preventDefault();
    ...
    $('#actualizarModal input[name="idestudiante"]').val(idEstudiante);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary text-center">
        <h4 class="modal-title text-white mx-auto" id="registroModalLabel">Registrar Estudiante</h4>
        <button type="button" class="close custom-close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('a.registrar-estudiante').click(function(e) {
      e.preventDefault();
